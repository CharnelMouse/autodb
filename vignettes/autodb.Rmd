...
nudge_title_relation <- nudge_database$title$df
...
nudge_title_relation_filtered <- nudge_database_filtered$title$df
...
ideal_db$patient_death$df <- subset(ideal_db$patient_death$df, !is.na(death_date))
...
knitr::kable(db_options$value$df)
knitr::kable(db_options$lower_bound$df)
knitr::kable(db_options$upper_bound$df)
```
...
knitr::kable(db_options_with_presence$value_present$df)
```
