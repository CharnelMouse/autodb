  ...
  describe("database_schema", {
    ...
    it("converts attribute/df names to snake case for labels (inc. spaces, periods)", {
      ...
      expected_string <- paste(
        ...
        "  genre_id [label = <",
        "    <TABLE BORDER=\"0\" CELLBORDER=\"1\" CELLSPACING=\"0\" CELLPADDING=\"4\">",
        "    <TR><TD COLSPAN=\"3\">Genre ID</TD></TR>",
        "    <TR><TD PORT=\"TO_genre_id\">Genre ID</TD><TD BGCOLOR=\"black\"></TD><TD PORT=\"FROM_genre_id\">logical</TD></TR>",
        "    <TR><TD PORT=\"TO_genre_name\">Genre Name</TD><TD></TD><TD PORT=\"FROM_genre_name\">logical</TD></TR>",
        "    </TABLE>>];",
        "",
        "",
        "}",
