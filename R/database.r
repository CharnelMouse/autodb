...
#' @exportS3Method
insert.database <- function(x, vals, relations = names(x), all = FALSE, digits = getOption("digits"), ...) {
  new_subrelations <- insert(subrelations(x), vals, relations, all, digits = digits, ...)
